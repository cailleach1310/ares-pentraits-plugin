...
## Compatibility
This plugin in its most recent version can be used with AresMUSH 2.0. If you have an earlier version of this plugin installed and need to upgrade, run the install from the game client again and make the latest adjustments to webportal chargen and profile custom files.
